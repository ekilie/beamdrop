              ...
              <Card className="p-4 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <pre className="p-3 bg-muted rounded-lg text-xs font-mono">
                      curl "{baseUrl}/api/v1/buckets/my-files/photos/photo.jpg"
                      -o photo.jpg
                    </pre>
                  </div>
                </div>
            ...
            <TabsContent value="auth" className="space-y-4 pr-4">
              <Card className="p-4 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  When API authentication is enabled (-api-auth flag), you need
                  to include your credentials in the request headers.
                </p>
    ...
    return base64.b64encode(signature).decode()`}
              ...
              <Card className="p-4 bg-blue-500/5 border-blue-500/20">
                <p className="text-sm text-blue-600 dark:text-blue-400">
                  <strong>Tip:</strong> For testing and development, you can
                  disable API authentication by not using the -api-auth flag.
                  All API endpoints will be publicly accessible within your
                  network.
                </p>
              </Card>
            </TabsContent>
