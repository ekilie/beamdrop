        ...
        {createdKey ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-600/80 dark:text-yellow-400/80 mt-1">
                    This is the only time you'll see this secret key. Copy it
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  ...
                  <Badge
                    variant="secondary"
                    className="font-mono text-xs bg-green-500/10 text-green-600"
                  >
                    Active
                  </Badge>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      handleCopy(createdKey.accessKeyId, "Access Key ID")
                    }
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      handleCopy(createdKey.secretKey, "Secret Key")
                    }
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground font-mono">
                Limit this key to a specific bucket. Leave empty for all
                buckets.
              </p>
            </div>
